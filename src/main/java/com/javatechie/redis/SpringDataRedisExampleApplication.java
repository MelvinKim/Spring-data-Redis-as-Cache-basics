...
public class SpringDataRedisExampleApplication {
    ...
    //@CachePut => when you want to update something in the db and in the Cache as well
    //@CacheEvict => delete a record, and delete you cache as well
    //value => represents the HashKey
